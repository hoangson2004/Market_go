...
export default function DishRecipe({ route }) {
    ...
    if (!recipe) {
        return <Text style={styles.errorText}>Dish not found</Text>;
    }
                ...
                {recipe.Ingredients.map((item) => {
                    return (
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                navigation.navigate('Recipe Ingredient', { itemId: item.ItemID })
                            }}
                        >
