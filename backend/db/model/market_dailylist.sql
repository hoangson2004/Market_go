...
CREATE TABLE `dailylist` (
  `ListID` int NOT NULL,
  `UserID` int NOT NULL,
  `DateToBuy` date DEFAULT NULL,
  `Cost` double DEFAULT NULL,
  PRIMARY KEY (`ListID`,`UserID`),
  UNIQUE KEY `unique_user_date` (`UserID`,`DateToBuy`),
  CONSTRAINT `dailylist_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`)
...
INSERT INTO `dailylist` VALUES (0,0,'2024-11-10',99),(1,0,'2024-11-09',20),(2,0,'2024-11-27',NULL),(3,0,'2024-11-20',NULL),(4,0,'2024-11-15',100);
